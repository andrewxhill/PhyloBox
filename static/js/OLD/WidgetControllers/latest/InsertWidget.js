...
function createMenu(elem,appId,canvasId,width){
    var newdiv = document.createElement('div');
    $(elem).css('position','relative');
    $(newdiv).attr('id',"PhyloBox-Menu-"+canvasId);
    $(newdiv).css({'width':"100%",'width':width+'px','min-width':"200px",'height':"27px",'background-color':'#444','float':'left','position':'relative','border':'1px solid #444','padding-top':'1px','padding-bottom':'1px'});
    ...
    PHYLOBOX = {
        ...
        loadTrees : function() {
            ...
            $('div.phylobox_embed_parent').each(function(){
                ...
                if(!fullscreen) createMenu(this,appId,canvasId,pbWIDTH);
                if(fullscreen) $('body').css({'overflow':'hidden','border':'0px','padding':'0px','margin':'0px'});
