...
var TreeTools = Class.extend({ // Scene carries instances of this Class
    ...
    // lastX,lastY are click location, (firstX,firstY can be used later to reconstruct movement)
     _cid:null, _firstM:{x:null,y:null}, _lastM:{x:null,y:null}, _padding:30, // padding is clickable area radius
    // constructor 
	init:function(cid) {
    	this._cid = cid;
...
var Scene3D = Class.extend({
	// private vars
	_vpx:0, _vpy:0, _cx:0, _cy:0, _cz:0, _dx:0, _dy:0, _dz:0, _ax:0, _ay:0, _az:0, _viewmode:0,
	// constructor
		...
		$(window).bind("keydown",function(e) {
            ...
            if(code==16) __this._shiftdown=true;
				...
				//switch view mode
					...
					__this._viewmode = __this._viewmode < 5 ? __this._viewmode + 1 : 0;
